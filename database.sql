...
CREATE TABLE IF NOT EXISTS `experience_professionnelle` (
  ...
  CONSTRAINT `fk_experience_professionnelle_type_contrat1`
    ...
    REFERENCES `type_contrat` (`type_contrat_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `media` (
  ...
  CONSTRAINT `fk_media_certification1`
    ...
    REFERENCES `certification` (`certification_id` , `profil_profil_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_media_education1`
    FOREIGN KEY (`education_education_id` , `education_Adresse_Adresse_id` , `education_profil_profil_id`)
    REFERENCES `education` (`education_id` , `Adresse_Adresse_id` , `profil_profil_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_media_experience_professionnelle1`
    ...
    REFERENCES `experience_professionnelle` (`experience_professionnelle_id` , `profil_profil_id` , `type_contrat_type_contrat_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `referent` (
  ...
  CONSTRAINT `fk_referent_experience_professionnelle1`
    ...
    REFERENCES `experience_professionnelle` (`experience_professionnelle_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
